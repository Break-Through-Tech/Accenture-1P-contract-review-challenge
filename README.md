# AI Studio Challenge: Accenture 1P
...
| -------------- | -------------- | ----------------------------------------------------------------------- |
| Annabel Wang   | @wang-annabel  | Data collection, exploratory data analysis (EDA), dataset documentation |
| Adriana Soldat | @adrianasoldat | Data collection, exploratory data analysis (EDA), dataset documentation |
...
```
git clone https://github.com/Break-Through-Tech/Accenture-1P-contract-review-challenge.git
```
...
Using the CUAD dataset: https://doi.org/10.48550/arXiv.2103.06268
